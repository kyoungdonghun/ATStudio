...
VALUES
    (1, 'Sunny Piano',       NULL, 120, 'C',  '밝고 경쾌한 피아노 멜로디',           'tracks/audio/track01_piano_c.wav',      NULL,  30, 1, 1, 152),
    (2, 'Synth Wave',        NULL, 128, 'E',  '신스 사운드의 몽환적 분위기',           'tracks/audio/track02_synth_high.wav',   NULL,  45, 1, 1, 87),
    (3, 'Deep Bass',         NULL,  90, 'Am', '깊은 베이스 라인의 힙합 비트',          'tracks/audio/track03_bass_low.wav',     NULL,  60, 1, 1, 234),
    (4, 'Ambient Garden',    NULL,  85, 'G',  '자연 속 잔잔한 앰비언트',              'tracks/audio/track04_ambient_g.wav',    NULL,  90, 1, 1, 56),
    (5, 'Lofi Study',        NULL,  75, 'C',  '집중할 때 듣기 좋은 로파이 비트',       'tracks/audio/track05_lofi_mid.wav',     NULL, 120, 1, 1, 412),
    (6, 'EDM Drop',          NULL, 140, 'D',  '강렬한 EDM 드롭',                    'tracks/audio/track06_edm_d.wav',       NULL,  30, 1, 1, 198),
    (7, 'Acoustic Morning',  NULL, 100, 'F',  '아침에 어울리는 어쿠스틱 기타',         'tracks/audio/track07_acoustic_f.wav',   NULL,  45, 1, 1, 321),
   ...
   (33, 'Ocean Breeze',        NULL,  78, 'G',  '바다 바람의 여유로움',                 'tracks/audio/track03_bass_low.wav',    NULL,  90, 1, 1, 267),
   (34, 'Retro Disco',         NULL, 115, 'Bb', '레트로 디스코 파티',                  'tracks/audio/track04_ambient_g.wav',   NULL,  45, 1, 1, 198),
   (35, 'Sakura Wind',         NULL,  92, 'D',  '벚꽃이 날리는 봄바람',                'tracks/audio/track05_lofi_mid.wav',    NULL, 120, 1, 1, 423),
   (36, 'Thunder Strike',      NULL, 155, 'Am', '천둥 같은 강렬한 비트',               'tracks/audio/track06_edm_d.wav',      NULL,  30, 1, 1, 156),
   (37, 'Starlight Waltz',     NULL,  76, 'F',  '별빛 아래 왈츠',                     'tracks/audio/track07_acoustic_f.wav',  NULL, 180, 1, 1, 89),
   (38, 'Street Hustle',       NULL, 100, 'Cm', '스트릿 허슬 비트',                   'tracks/audio/track08_cinematic_bb.wav', NULL, 60, 1, 1, 334),
   (39, 'Fireplace',           NULL,  68, 'Ab', '벽난로 앞의 평온한 시간',              'tracks/audio/track09_hiphop_d.wav',   NULL, 120, 1, 1, 145),
   (40, 'Digital Dream',       NULL, 138, 'E',  '디지털 세계의 꿈',                   'tracks/audio/track10_rnb_ab.wav',     NULL,  45, 1, 1, 278),
   (41, 'Bamboo Forest',       NULL,  72, 'G',  '대나무 숲의 고요함',                  'tracks/audio/track01_piano_c.wav',     NULL,  90, 1, 1, 167),
   (42, 'Pixel Adventure',     NULL, 142, 'C',  '픽셀 모험 게임 OST',                'tracks/audio/track02_synth_high.wav',  NULL,  30, 1, 1, 445),
   (43, 'Sunset Boulevard',    NULL,  98, 'D',  '석양의 대로',                        'tracks/audio/track03_bass_low.wav',    NULL,  60, 1, 1, 201),
   (44, 'Midnight Run',        NULL, 128, 'Fm', '자정의 질주',                        'tracks/audio/track04_ambient_g.wav',   NULL,  45, 1, 1, 356),
   (45, 'Cherry Blossom',      NULL,  85, 'Bb', '벚꽃 피는 거리',                     'tracks/audio/track05_lofi_mid.wav',    NULL, 120, 1, 1, 289),
   (46, 'Cosmic Voyage',       NULL, 148, 'A',  '우주 항해의 사운드',                  'tracks/audio/track06_edm_d.wav',      NULL,  60, 1, 1, 178),
   (47, 'Lullaby Moon',        NULL,  62, 'F',  '달빛 아래 자장가',                   'tracks/audio/track07_acoustic_f.wav',  NULL, 180, 1, 1, 134),
   (48, 'Groove Machine',      NULL, 118, 'Dm', '그루브 머신 비트',                   'tracks/audio/track08_cinematic_bb.wav', NULL, 45, 1, 1, 312),
   (49, 'Arctic Wind',         NULL,  70, 'Em', '북극의 차가운 바람',                  'tracks/audio/track09_hiphop_d.wav',   NULL,  90, 1, 1, 98),
   (50, 'Festival Anthem',     NULL, 135, 'G',  '페스티벌 앤썸',                      'tracks/audio/track10_rnb_ab.wav',     NULL,  30, 1, 1, 567),
   (51, 'Rainy Window',        NULL,  74, 'Am', '빗소리가 들리는 창가',                'tracks/audio/track01_piano_c.wav',     NULL, 120, 1, 1, 234),
   (52, 'Cyber Punk',          NULL, 145, 'Cm', '사이버펑크 도시의 소리',               'tracks/audio/track02_synth_high.wav',  NULL,  45, 1, 1, 189),
   (53, 'Garden Party',        NULL, 105, 'C',  '가든 파티의 즐거움',                  'tracks/audio/track03_bass_low.wav',    NULL,  60, 1, 1, 167),
   (54, 'Desert Mirage',       NULL,  90, 'Bb', '사막의 신기루',                      'tracks/audio/track04_ambient_g.wav',   NULL,  90, 1, 1, 123),
   (55, 'Spring Rain',         NULL,  80, 'F',  '봄비 내리는 오후',                   'tracks/audio/track05_lofi_mid.wav',    NULL, 120, 1, 1, 345),
   (56, 'Turbo Boost',         NULL, 160, 'D',  '터보 부스트 레이싱',                  'tracks/audio/track06_edm_d.wav',      NULL,  30, 1, 1, 234),
   (57, 'Candlelight',         NULL,  66, 'G',  '촛불 아래 저녁',                     'tracks/audio/track07_acoustic_f.wav',  NULL, 180, 1, 1, 156),
   (58, 'Soul Train',          NULL, 112, 'Ab', '소울 트레인 펑크',                   'tracks/audio/track08_cinematic_bb.wav', NULL, 60, 1, 1, 278),
   (59, 'Frozen Lake',         NULL,  68, 'Em', '얼어붙은 호수의 고요',                'tracks/audio/track09_hiphop_d.wav',   NULL,  90, 1, 1, 87),
   (60, 'Summer Festival',     NULL, 130, 'C',  '여름 페스티벌',                      'tracks/audio/track10_rnb_ab.wav',     NULL,  45, 1, 1, 478),
   -- Batch 3: tracks 61-90
   (61, 'Velvet Night',        NULL,  95, 'Bb', '벨벳 같은 밤',                      'tracks/audio/track01_piano_c.wav',     NULL, 120, 1, 1, 198),
   (62, 'Electric Storm',      NULL, 152, 'Am', '일렉트릭 폭풍',                     'tracks/audio/track02_synth_high.wav',  NULL,  30, 1, 1, 345),
   (63, 'Misty Mountain',      NULL,  82, 'G',  '안개 낀 산의 아침',                  'tracks/audio/track03_bass_low.wav',    NULL,  90, 1, 1, 167),
   (64, 'Roller Coaster',      NULL, 140, 'D',  '롤러코스터 같은 비트',                'tracks/audio/track04_ambient_g.wav',   NULL,  45, 1, 1, 289),
   (65, 'Autumn Leaves',       NULL,  78, 'F',  '가을 낙엽이 떨어지는 소리',            'tracks/audio/track05_lofi_mid.wav',    NULL, 120, 1, 1, 312),
   (66, 'Gravity Drop',        NULL, 158, 'Cm', '중력 드롭 베이스',                   'tracks/audio/track06_edm_d.wav',      NULL,  30, 1, 1, 234),
   (67, 'Moonlit Sonata',      NULL,  72, 'Ab', '달빛 소나타',                       'tracks/audio/track07_acoustic_f.wav',  NULL, 180, 1, 1, 145),
   (68, 'Underground',         NULL, 108, 'Em', '언더그라운드 씬',                    'tracks/audio/track08_cinematic_bb.wav', NULL, 60, 1, 1, 378),
   (69, 'Snowfall',            NULL,  64, 'C',  '첫눈이 내리는 밤',                   'tracks/audio/track09_hiphop_d.wav',   NULL, 120, 1, 1, 201),
   (70, 'Carnival',            NULL, 125, 'Bb', '카니발의 활기',                      'tracks/audio/track10_rnb_ab.wav',     NULL,  45, 1, 1, 456),
   (71, 'Silk Road',           NULL,  88, 'Dm', '실크로드 여행',                      'tracks/audio/track01_piano_c.wav',     NULL,  90, 1, 1, 178),
   (72, 'Laser Tag',           NULL, 148, 'E',  '레이저 태그 게임',                   'tracks/audio/track02_synth_high.wav',  NULL,  30, 1, 1, 267),
   (73, 'Twilight Zone',       NULL,  76, 'Fm', '황혼의 영역',                       'tracks/audio/track03_bass_low.wav',    NULL, 120, 1, 1, 134),
   (74, 'Speed Racer',         NULL, 165, 'A',  '스피드 레이서',                      'tracks/audio/track04_ambient_g.wav',   NULL,  30, 1, 1, 412),
   (75, 'Petal Dance',         NULL,  84, 'G',  '꽃잎이 춤추는 정원',                  'tracks/audio/track05_lofi_mid.wav',    NULL,  90, 1, 1, 256),
   (76, 'Bass Cannon',         NULL, 155, 'Cm', '베이스 캐논',                       'tracks/audio/track06_edm_d.wav',      NULL,  45, 1, 1, 189),
   (77, 'Gentle Stream',       NULL,  70, 'D',  '잔잔한 시냇물 소리',                  'tracks/audio/track07_acoustic_f.wav',  NULL, 180, 1, 1, 98),
   (78, 'Breakbeat City',      NULL, 120, 'Bb', '브레이크비트 도시',                   'tracks/audio/track08_cinematic_bb.wav', NULL, 60, 1, 1, 345),
   (79, 'Winter Cabin',        NULL,  66, 'F',  '겨울 산장의 밤',                     'tracks/audio/track09_hiphop_d.wav',   NULL, 120, 1, 1, 112),
   (80, 'Rave On',             NULL, 138, 'Am', '레이브 파티',                       'tracks/audio/track10_rnb_ab.wav',     NULL,  30, 1, 1, 534),
   (81, 'Cafe Latte',          NULL,  92, 'C',  '카페 라떼 한 잔',                    'tracks/audio/track01_piano_c.wav',     NULL,  60, 1, 1, 223),
   (82, 'Glitch Hop',          NULL, 115, 'Em', '글리치 홉 비트',                     'tracks/audio/track02_synth_high.wav',  NULL,  45, 1, 1, 167),
   (83, 'Mountain Peak',       NULL,  80, 'Ab', '산 정상의 풍경',                     'tracks/audio/track03_bass_low.wav',    NULL,  90, 1, 1, 289),
   (84, 'Night Drive',         NULL, 110, 'Dm', '밤의 드라이브',                      'tracks/audio/track04_ambient_g.wav',   NULL, 120, 1, 1, 356),
   (85, 'Blossom Garden',      NULL,  86, 'G',  '꽃이 만발한 정원',                   'tracks/audio/track05_lofi_mid.wav',    NULL,  60, 1, 1, 198),
   (86, 'Overdrive',           NULL, 162, 'E',  '오버드라이브 기타',                   'tracks/audio/track06_edm_d.wav',      NULL,  30, 1, 1, 412),
   (87, 'Lakeview',            NULL,  74, 'F',  '호수가 보이는 풍경',                  'tracks/audio/track07_acoustic_f.wav',  NULL, 180, 1, 1, 145),
   (88, 'Dub Step',            NULL, 142, 'Cm', '덥스텝 웨이브',                      'tracks/audio/track08_cinematic_bb.wav', NULL, 45, 1, 1, 267),
   (89, 'Silent Snow',         NULL,  60, 'Bb', '고요한 눈 내리는 밤',                 'tracks/audio/track09_hiphop_d.wav',   NULL, 120, 1, 1, 78),
   (90, 'Bounce Back',         NULL, 128, 'D',  '바운스 백 비트',                     'tracks/audio/track10_rnb_ab.wav',     NULL,  45, 1, 1, 489);
