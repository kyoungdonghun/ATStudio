...
| :-- | :-- | :-- |
| Tax invoice request/admin workflow | Business customers may need tax invoice request tracking, review, rejection, completion, and external issue number storage. | After payment client acceptance or before business-customer production launch. |
...
| Admin tax/receipt/audit polish | Admin UI can be expanded around future tax invoice and receipt operation needs. | With tax invoice or cash-like payment scope. |
...
| :-- | :-- |
| Tax invoice request/admin workflow | User request form, admin list/detail, status workflow, external issue number, payment/refund linkage, audit log. |
