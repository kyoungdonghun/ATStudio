...
Revert only the WI-012 documentation changes and the two Track COMMENT wording changes in `schema.sql`. Do not change schema structure/data and do not revert source, test, runtime, or unrelated shared-worktree edits.
