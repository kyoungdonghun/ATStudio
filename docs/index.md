...
> **Single operational flow**: `MA + Subagents + Skills` (details: `docs/architecture/system-design.md`, `CLAUDE.md`)
...
| Design | 5 | [Design Index](design/index.md) | Meta + ATStudio domain design (api-spec, db-schema, usecase/, A2A protocol) |
...
1. **`CLAUDE.md`** (root): Work workflow, orchestration gates, routing — **start here** ⭐
2. **[System Design](architecture/system-design.md)**: Big picture/principles
