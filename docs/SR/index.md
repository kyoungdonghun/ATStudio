...
| SR-79 | 다운로드 기록 페이지 전면 개편 (구 다운로드 대기열) | OPEN |
| SR-80 | 음원 목록 Buy 버튼 제거 + 태그 영역 % 고정·+10% 확대 | OPEN |
| SR-81 | 아티스트 표기 전면 숨김 (목록/상세/플레이어바) | OPEN |
| SR-82 | 플레이어 대기열 → 재생기록 교체 + 썸네일 클릭 상세 이동 | OPEN |
