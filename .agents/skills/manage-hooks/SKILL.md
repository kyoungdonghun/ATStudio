...
```bash
# List hooks
python3 .agents/skills/manage-hooks/scripts/hook_manager.py list

# Install hook
python3 .agents/skills/manage-hooks/scripts/hook_manager.py install docs-validation

# Disable hook
python3 .agents/skills/manage-hooks/scripts/hook_manager.py disable pre-commit
```
