...
Reference: `AGENTS.md` → Language Policy (Three-Track) → REQ (Exception)
...
(Subagent and Model are defined in AGENTS.md Routing Matrix - single source of truth)
...
- **Plan execution strategy**: Assign tasks to appropriate subagents based on routing matrix in AGENTS.md
