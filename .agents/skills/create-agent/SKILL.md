...
cp .agents/skills/create-agent/assets/agent-template.md .claude/agents/<name>.md
```
...
1. Add to AGENTS.md routing matrix
...
- [ ] Agent is registered in AGENTS.md routing matrix
