...
# WI-20260909-ATS-009: Lint Formatting and Build

[WI HEADER]
WI ID: WI-20260909-ATS-009
...
Scope: Analyze MA-serialized frontend lint, Prettier and build outputs. Distinguish warnings from failures and production-bundle proof from browser/runtime proof. No product edits or independent runner.
...
[OUTPUT CONTRACT]
User-facing: deliverables/user/WI-20260909-ATS-009-summary.md.
Agent-facing: deliverables/agent/WI-20260909-ATS-009-evidence-pack.md.
