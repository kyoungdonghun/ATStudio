...
# WI-20260908-ATS-017: File, Download and Domain Access Boundaries

[WI HEADER]
WI ID: WI-20260908-ATS-017
...
Scope: TrackController/TrackService, LocalStorageService and storage mutation/integrity, FileServingController/WebConfig, NoticeService attachments, CompanyCertificationService/document access, WhitelistChannelService/admin export and PlaylistService. Check path traversal/symlinks/SSRF/content-type, streaming versus original file download, quota ownership and transaction boundaries, upload validation/private document access, CSV injection and whitelist/certification state/limit exceptions. Include frontend input/output counterpart only when material.
...
MA closeout: review accepted into WI018; two P1 and two P2 findings, not implemented. Album/quota counterparts confirmed. Reviewer closed after report verification. Blocks dependency consumed by WI018.
...
[OUTPUT CONTRACT]
Agent-facing: deliverables/agent/WI-20260908-ATS-017-evidence-pack.md
User-facing: deliverables/user/WI-20260908-ATS-017-summary.md
