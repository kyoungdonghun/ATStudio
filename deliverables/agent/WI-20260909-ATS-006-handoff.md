...
# WI-20260909-ATS-006: Backend Regression and Coverage

[WI HEADER]
WI ID: WI-20260909-ATS-006
...
Scope: Analyze the MA-serialized isolated H2 test/build/JaCoCo commands and exact results. Identify failures/skips, confirm current thresholds unchanged. No product edits or independent heavy runner. Author evidence and summary after MA provides raw outputs.
...
[OUTPUT CONTRACT]
User-facing: deliverables/user/WI-20260909-ATS-006-summary.md.
Agent-facing: deliverables/agent/WI-20260909-ATS-006-evidence-pack.md.
