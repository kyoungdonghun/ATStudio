...
Scope: Independently review DATA-01/02/03, STORAGE-04 and DEP/OPS corrections. Check deletion audit symmetry/shared references, writer coverage/lock ordering, partial staging cleanup ownership, finite multipart and compatible patches. No real data changes, no heavy runners. Separate concrete blockers from maintenance.
...
[OUTPUT CONTRACT]
User-facing: deliverables/user/WI-20260909-ATS-012-summary.md.
Agent-facing: deliverables/agent/WI-20260909-ATS-012-evidence-pack.md.
