...
### [FILE 1] docs/check/atstudio-front-list.md

---

**AC-1: 헤더 버전 표기 갱신**

- File: `docs/check/atstudio-front-list.md` line 3
...
- File: `docs/check/atstudio-front-list.md` line 73
...
- File: `docs/check/atstudio-front-list.md` line 51
...
- File: `docs/check/atstudio-front-list.md` line 53
...
- File: `docs/check/atstudio-front-list.md` line 132
...
### [FILE 2] docs/check/modal-list.md

---

**AC-6: M-05 — playlists/{id}/tracks**

- File: `docs/check/modal-list.md` Section 1 테이블 M-05행
...
- File: `docs/check/modal-list.md` Section 1 테이블 M-07행
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-11행
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-12행
- Before: `3.4 POST /api/playlists/{id}/tracks`
- After: `3.4 POST /api/playlists/{playlistId}/tracks`
- API Spec ref: §3.4 `POST /api/playlists/{playlistId}/tracks`
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-13행
- Before: `3.8 DELETE /api/playlists/{id}`
- After: `3.8 DELETE /api/playlists/{playlistId}`
- API Spec ref: §3.8 `DELETE /api/playlists/{playlistId}`
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-18행
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-21행
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-24행
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-25행
...
- File: `docs/check/modal-list.md` Section 2 테이블 M-28행
...
- File: `docs/check/modal-list.md` Section 3 Flow 1 code block
- Before: `3.8 DELETE /api/playlists/{id}`
- After: `3.8 DELETE /api/playlists/{playlistId}`
...
- File: `docs/check/modal-list.md` Section 3 Flow 3 code block
- Before: `3.4 POST /api/playlists/{id}/tracks`
- After: `3.4 POST /api/playlists/{playlistId}/tracks`
- Rationale: 테이블과 다이어그램 내 표기 일관성 유지.
...
### [FILE 3] docs/check/screen-flow.md

---

**AC-18: Section 4 재생목록 생성 플로우 레이블 추가**

- File: `docs/check/screen-flow.md` Section 4 (line 98)
- Before: `[재생목록 생성]`
- After: `[8 재생목록 생성]`
...
- File: `docs/check/screen-flow.md` Section 10 (line 282)
- Before: `[K-5 기업인증 심사]`
...
- File: `docs/check/screen-flow.md` Section 6 (line 157)
- Before: `1.5 GET /api/tracks/{id}/download`
- After: `1.5 GET /api/tracks/{trackId}/download`
- API Spec ref: §1.5 `GET /api/tracks/{trackId}/download`
...
- `docs/check/atstudio-front-list.md` (수정)
- `docs/check/modal-list.md` (수정)
- `docs/check/screen-flow.md` (수정)
