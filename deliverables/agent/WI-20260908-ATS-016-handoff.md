...
# WI-20260908-ATS-016: Payment and Subscription Policy Invariants

[WI HEADER]
WI ID: WI-20260908-ATS-016
...
Scope: PaymentService/command transactions, UserSubscriptionService, SubscriptionUpgradePaymentExecutor, SubscriptionScheduler, AdminPaymentRefundService/transaction, entitlement correction and provider adapters plus frontend checkout/subscription previews. Check server-authoritative price/ownership/provider selection, idempotency, provider-success/local-failure behavior, failed callback recovery, renewals/cancel/reactivate, refund-versus-access and annual tier/current period versus next monthly cycle. Compare approved payment policies; do not redefine free streaming/card-only/single-server policies.
...
MA closeout: review accepted into WI018; two P1 findings, not implemented. Reviewer closed after report verification. Blocks dependency consumed by WI018.
...
[OUTPUT CONTRACT]
Agent-facing: deliverables/agent/WI-20260908-ATS-016-evidence-pack.md
User-facing: deliverables/user/WI-20260908-ATS-016-summary.md
