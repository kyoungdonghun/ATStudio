...
# WI-20260909-ATS-007: Frontend Regression

[WI HEADER]
WI ID: WI-20260909-ATS-007
...
Scope: Analyze MA-serialized full Vitest tests and new session-ownership regressions. Record exact counts and failures, no product edits or independent runner.
...
[OUTPUT CONTRACT]
User-facing: deliverables/user/WI-20260909-ATS-007-summary.md.
Agent-facing: deliverables/agent/WI-20260909-ATS-007-evidence-pack.md.
