...
Scope: Independently review PAY-01/02 changes/tests: retained expired subscription, active/replaced guards, exact recovery, competing upgrades with different keys/cycles/targets and UNKNOWN outcomes. Follow all provider routes and finalization contracts. Read-only product review; fake evidence only, no actual provider/DB actions.
...
[OUTPUT CONTRACT]
User-facing: deliverables/user/WI-20260909-ATS-011-summary.md.
Agent-facing: deliverables/agent/WI-20260909-ATS-011-evidence-pack.md.
